...
def render_homepage():
    ...
    <div style="text-align: center; padding: 2rem 0 1.5rem 0;">
        <h1 style="font-size: 1.5rem; margin-bottom: 0.5rem; color: #1f2937; font-weight: 600;">电商场景供给系统与智能导购</h1>
    ...
    st.markdown('<h2 style="text-align: center; margin: 1rem 0 1.5rem 0; font-size: 1.5rem;">电商场景供给</h2>', unsafe_allow_html=True)
    ...
    # ===== AI 场景导购（功能二：AI 购物助手）=====
    st.markdown('<h2 style="text-align: center; margin: 1rem 0 1.5rem 0; font-size: 1.5rem;">电商智能导购</h2>', unsafe_allow_html=True)
    ...
    with ai_col1:
        ...
        <div class="hero-card" style="text-align:left; min-height: 15rem;">
            ...
            <p style="color: #6b7280; margin: 0 0 1rem 0; font-size: 0.88rem; line-height: 1.6;">
                系统融合你的用户画像与当下热门的时节、热点场景，由大模型实时推理，为你智能生成千人千面的个性化商品推荐列表——让每一次推荐都精准契合你的真实需求与当下时机。
            </p>
        </div>
        ''', unsafe_allow_html=True)
